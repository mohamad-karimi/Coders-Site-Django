...
class Course(models.Model):
    ...
    certification = models.CharField(max_length=20, choices=CERTIFICATION_CHOICES, null=True)
    tag = TaggableManager()
...
class Score(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, blank=True, related_name="scores")
...
class ReplayComment(models.Model):
    author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="replaycomment")
    comment = models.TextField()
    question_comment = models.ForeignKey(
        Comment, on_delete=models.CASCADE, related_name="replaycomment")
    created_date = models.DateTimeField(auto_now_add=True)
    updated_date = models.DateTimeField(auto_now=True)
...
class Enrollment(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="enrollment")
    course = models.ForeignKey(
